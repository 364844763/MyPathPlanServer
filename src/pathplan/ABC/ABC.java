...
public class ABC {
    ...
    public ABC(String start, String end, HashMap<String, Path> paths, ArrayList<Node> nodes) {
        this.start = start;
        this.end = end;
        this.paths =paths;
        this.nodes=nodes;
...
//            System.out.println(node.getNodeId());
    ...
    public ABC(String start, String end, ArrayList<Node> nodes, HashMap<Relation, Path> edges, HashMap<String, Node> map) {
        this.start = start;
        this.end = end;
        this.nodes=nodes;
        this.edges=edges;
...
//                Bee ant = new Bee(nodes,edges,map,pheromone,alpha,beta,start,end);
                pathplan.aco.Ant ant = new Ant(start,end,beta,alpha,paths,map);
